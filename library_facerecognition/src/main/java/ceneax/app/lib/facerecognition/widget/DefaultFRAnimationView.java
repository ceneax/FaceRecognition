...
public class DefaultFRAnimationView extends FRAnimationView implements ViewTreeObserver.OnGlobalLayoutListener {
    // 画笔
    ...
    public DefaultFRAnimationView(Context context) {
        this(context, null);
    }

    public DefaultFRAnimationView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DefaultFRAnimationView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
